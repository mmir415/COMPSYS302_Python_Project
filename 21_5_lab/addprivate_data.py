...
private_data_hex = signing_key.verify_key.encode(encoder = nacl.encoding.HexEncoder)
private_data_hex_str = private_data_hex.decode(ENCODING)

#message = bytes("Happy Birthday, Matt!",ENCODING)
...
message_bytes = bytes(private_data_hex_str + login_server_record + timing, encoding=ENCODING)
