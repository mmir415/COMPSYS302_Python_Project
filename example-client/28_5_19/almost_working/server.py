...
class MainApp(object):
    ...
    def signin(self, username=None, password=None):
        ...
        if error == 0:
            ...
            report(self,username,password)
            
            listusers(self,username,password)
            
            broadcast(self,username,password)
    ...
    def authoriseUserLogin(self,username, password):
        ...
        pubhexstr = (get_privatedata(self,username,password))
    # report(username,password)
        return (ping(self,username,password))
